...
public class Main {
    public static void main(String[] args) {
        ...
        // Product CRUD
        Product newProduct = new Product(141, "Grapes", 4.0, 20);
        ...
        // Customer CRUD
        Customer newCustomer = new Customer(21, "Alice Johnson", "alice@example.com");
        ...
        List<Product> searchResults = ps.searchByName("Apple");
        searchResults.forEach(System.out::println);

        System.out.println("\n=== Filter Products (price range: 1.0 - 5.0) ===");
        List<Product> filteredProducts = ps.filterByPrice(1.0, 5.0);
